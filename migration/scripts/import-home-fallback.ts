...
const assetSources = {
  ...
  plancheFond: 'src/assets/sections/planche-fond.webp',
...
async function main() {
  ...
  const sections = [
    ...
    },
    {
      _key: 'plate',
      _type: 'plateSpread',
      background: { ...images.plancheFond, alt: '' },
      figures: [
        {
          _key: 'p1',
          _type: 'object',
          image: { ...images.plancheMain, alt: 'Ancolie, famille des ranunculacées' },
          number: 'fig.01',
        ...
        },
        {
          _key: 'p2',
          _type: 'object',
          image: { ...images.plancheCercle, alt: 'Asphodèle, famille des liliacées' },
          number: 'fig.02',
