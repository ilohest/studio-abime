...
const fr = {
  ...
  */
  ...
  'home.fieldDescription':
    'Double page typographique : une pile du mot « visible » sur chaque feuille, séparées par un filet central. Chaque lettre se tourne vers le pointeur, qui porte les mots « sous le ».',
  ...
  'library.all': 'L’ensemble',
  'library.rubrics': 'Rubriques',
  'library.otherRubrics': 'Autres rubriques de la bibliothèque',
  'library.empty': 'Aucun article dans cette rubrique.',
  'library.emptyAll': 'La Bibliothèque ouvre bientôt ses pages.',
  'library.count': 'article(s)',
  'library.read': 'Lire l’article',
  'library.back': 'Retour à la bibliothèque',
  'library.next': 'Article suivant',
  'library.compositionLabel': 'Choisir une rubrique',
  'library.note': 'Note',
  'library.notes': 'Notes de bas de page',
  'library.start': 'début',
  'library.end': 'fin',
  'shop.title': 'Shop',
  ...
  'shop.ctaGift': 'J’investis pour un·e proche',
  'shop.giftLegend': 'À qui l’offrir',
  'shop.giftEmail': 'Courriel du destinataire',
  'shop.giftName': 'Nom du destinataire',
  'shop.giftMessage': 'Message',
  'shop.giftSendOn': 'Envoyer le',
  'shop.giftNote':
    'Shopify envoie la carte et son code à cette adresse. Sans date, elle part dès l’achat.',
  ...
  'cart.recipient': 'Pour',
  'cart.note': 'Note pour la commande (facultatif)',
  ...
  */
  ...
  'a11y.railScrollDown': 'Voir la suite du menu',
  'a11y.railScrollUp': 'Revenir au début du menu',
...
const en: Partial<Record<TranslationKey, string>> = {
  ...
  'home.fieldDescription':
    'Typographic spread: a stack of the word “visible” on each page, separated by a central rule. Every letter turns toward the pointer, which carries the words “beneath the”.',
  'labo.sectionServices': 'Services',
  'labo.sectionVision': 'Vision',
  ...
  'library.all': 'All',
  'library.rubrics': 'Sections',
  'library.otherRubrics': 'Other sections of the library',
  'library.empty': 'No article in this section.',
  'library.emptyAll': 'The library opens its pages soon.',
  'library.count': 'article(s)',
  'library.read': 'Read the article',
  'library.back': 'Back to the library',
  'library.next': 'Next article',
  'library.compositionLabel': 'Choose a section',
  'library.note': 'Note',
  'library.notes': 'Footnotes',
  'library.start': 'start',
  'library.end': 'end',
  'shop.title': 'Shop',
  ...
  'shop.ctaGift': 'I invest for a loved one',
  'shop.giftLegend': 'Who it’s for',
  'shop.giftEmail': 'Recipient’s email',
  'shop.giftName': 'Recipient’s name',
  'shop.giftMessage': 'Message',
  'shop.giftSendOn': 'Send on',
  'shop.giftNote':
    'Shopify sends the card and its code to this address. With no date, it goes out at once.',
  ...
  'a11y.railScrollDown': 'See more of the menu',
  'a11y.railScrollUp': 'Back to the top of the menu',
