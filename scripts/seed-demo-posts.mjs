 ...
 * Identifiant `post-demo-…` et slug `demo-…`. `--delete` ne touche QUE ces
 * identifiants : aucun article saisi à la main ne peut être emporté.
 *
...
const post = ({ id, title, slug, date, rubrics, cover, summary, blocks }) => ({
  _id: `post-demo-${id}`,
  _type: 'post',
  language: 'fr',
  title,
  ...
  rubrics,
  publishedAt: date,
  seo: summary ? { _type: 'seo', description: summary } : undefined,
  coverImage: cover,
  blocks,
});
...
const posts = [
  post({
    ...
    summary: 'Trois matins sur la même plage, à la même heure. Ce qui change n’est jamais ce qu’on attendait.',
    blocks: [
      prose(
  ...
  post({
    ...
    summary: 'Une réponse arrivée trois semaines après la question, et qui en posait une meilleure.',
    blocks: [
      prose(
  ...
  post({
    ...
    summary: 'Une semaine à tirer des bandes d’essai avant de tirer quoi que ce soit d’autre.',
    blocks: [
      prose(
  ...
  post({
    ...
    summary: 'Une question posée à chaque déménagement d’archives, et jamais tranchée.',
    blocks: [
      prose(
  ...
  post({
    ...
    summary: 'Une paroi, et la tentation de lire le temps comme on lit une page.',
    blocks: [
      prose(
  ...
  post({
    ...
    summary: 'Ce qu’on a lu, entendu, découpé pendant les semaines chaudes.',
    blocks: [
      prose(
  ...
  post({
    ...
    summary: 'Ils ne se répondent pas. C’est pour ça qu’ils sont ensemble.',
    blocks: [
      prose(
  ...
  post({
    ...
    summary: 'Classer, c’est déjà interpréter. La question est de savoir qui s’en souvient.',
    blocks: [
      prose(
  ...
  post({
    ...
    summary: 'Deux jours sous terre, et la lumière à réapprendre en sortant.',
    blocks: [
      prose(
  ...
  post({
    ...
    summary: 'Réparer sans effacer : un métier fait de décisions que personne ne voit.',
    blocks: [
      prose(
